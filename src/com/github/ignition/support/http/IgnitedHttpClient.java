...
import com.github.support.DiagnosticSupport;

/**
 * set up the HttpClient Params httpClient Wrap
 */
public class IgnitedHttpClient {

	static final String LOG_TAG = IgnitedHttpClient.class.getSimpleName();

	public static final int DEFAULT_MAX_CONNECTIONS = 3;
	public static final int DEFAULT_SOCKET_TIMEOUT = 6 * 1000;
	public static final int DEFAULT_READ_STREAM_TIMEOUT = 8 * 10000; 
	public static final int DEFAULT_WAIT_FOR_CONNECTION_TIMEOUT = 3 * 1000;

	// Change: change FROM "Android/Ignition" To "Android/AppClinet"
	public static final String DEFAULT_HTTP_USER_AGENT = "User-Agent: reddit mobile client app developed by /u/redditet";

	private HashMap<String, String> defaultHeaders = new HashMap<String, String>();
	protected AbstractHttpClient httpClient;
	private Context appContext;

	public IgnitedHttpClient(Context context) {
	...
	public IgnitedHttpRequest get(String url) {
		return new IgnitedHttpGet(this, url, defaultHeaders);
	}

	public IgnitedHttpRequest post(String url) {
		return new IgnitedHttpPost(this, url, defaultHeaders);
	}

	public IgnitedHttpRequest post(String url, HttpEntity payload) {
		return new IgnitedHttpPost(this, url, payload, defaultHeaders);
	}

	public IgnitedHttpRequest put(String url) {
		return new IgnitedHttpPut(this, url, defaultHeaders);
	}

	public IgnitedHttpRequest put(String url, HttpEntity payload) {
		return new IgnitedHttpPut(this, url, payload, defaultHeaders);
	}

	public IgnitedHttpRequest delete(String url) {
		return new IgnitedHttpDelete(this, url, defaultHeaders);
	}
