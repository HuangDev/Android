...
public class IgnitedHttpGet extends IgnitedHttpRequestBase {

	public IgnitedHttpGet(IgnitedHttpClient ignitedHttp, URI uri) {
		super(ignitedHttp);
		request = new org.apache.http.client.methods.HttpGet(uri);
	}

	public IgnitedHttpGet(IgnitedHttpClient ignitedHttp, String url,
